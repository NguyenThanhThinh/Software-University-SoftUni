...
class CommandInterpreter
{
    static void Main()
    {
        ...
        while (input != "end")
        {
            ...
            array = PerformCurrentCommand(array, result, command, start, count);
    ...
    private static List<string> PerformCurrentCommand(List<string> array, StringBuilder result, string command, int start, int count)
    {
        switch (command)
        {
            case "reverse":
