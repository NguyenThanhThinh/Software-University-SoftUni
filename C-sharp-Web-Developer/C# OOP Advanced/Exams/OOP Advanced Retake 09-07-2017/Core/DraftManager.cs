...
public class DraftManager
{
    ...
    //private IDictionary<string, IHarvester> harvestersById;
    //private IDictionary<string, IProvider> providersById;
    ...
    //    {
    //        sb.AppendLine(this.providersById[id].ToString());
    //    }
    //    if (this.harvestersById.ContainsKey(id))
    //    {
    //        sb.AppendLine(this.harvestersById[id].ToString());
    //    }
    ...
    //public IDictionary<string, IHarvester> HarvestersById
    //{
    //    get { return this.harvestersById; }
    //    set { this.harvestersById = value; }
    //}

    //public IDictionary<string, IProvider> ProvidersById
    //{
    //    get { return this.providersById; }
    //    set { this.providersById = value; }
    //}
}
