...
class DragonArmy
{
    ...
    // Поради някаква причина смятането на Avarage не работи коректно, и по-горе в кода, вместо да изкарваме резултата изпползвайки този метод
    // ползваме LINQ .Avarage
