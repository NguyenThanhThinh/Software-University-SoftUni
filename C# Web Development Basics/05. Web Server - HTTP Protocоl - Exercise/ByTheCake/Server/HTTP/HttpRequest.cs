namespace ByTheCake.Server.HTTP
{
    ...
    public class HttpRequest : IHttpRequest
    {
        ...
        private string url;
        private string path;
        private Dictionary<string, string> quearyParameters;
        ...
        public HttpRequest(string requestString)
        {
            ...
            this.QuearyParameters = new Dictionary<string, string>();
        ...
        public Dictionary<string, string> QuearyParameters
        {
            get { return this.quearyParameters; }
            private set { this.quearyParameters = value; }
        ...
        private void ParseParamaters()
        {
            ...
            this.ParseQuery(query, this.QuearyParameters);
        }
